...
const experts = [
  {
    ...
    description:
      "Выпускник мехмата МГУ. Выступал на конференциях Dump, CodeFest, MoscowJS, МУФ и SOC-Forum в сфере веб-резработки и кибербезопасности. 8 лет программирования на C++, Wolfram и Python, 5 лет на Javascript.",
  },
  {
