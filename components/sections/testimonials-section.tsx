...
const testimonials: Testimonial[] = [
  ...
  {
    author: "Михаил Гудов",
    text: `Как по мне - отличный курс, дает неплохую вводную для понимания работы LLM и AI-агентов. Буду применять знания на практике, писать своих агентов. Оказалось, все не так и сложно)`,
    telegram: "@mgudov",
    profilePicture: "mgudov.jpg",
    position: "разработчик на Go в компании Carprice",
  },
  {
    author: "Денис Образцов",
    text: `Просто во 👍
