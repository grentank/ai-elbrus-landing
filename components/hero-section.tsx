...
export default function HeroSection({ scrollToPayment }: { scrollToPayment: () => void }) {
    return (<section className="bg-gradient-to-r from-indigo-600 to-purple-600 py-20 text-white">
