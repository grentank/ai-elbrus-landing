...
const weeksData = [
  ...
  },
  {
    ...
    days: [
      ...
      {
        title: "Четверг: Генерация кода",
        description:
          "Создание продвинутого AI-агента, способного самостоятельно писать код и взаимодействовать с системами контроля версий.",
        points: [
          "Автоматизация написания кода с помощью AI",
          "Создание и запуск автотестов для написанного кода",
